...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:26px;"><h1><a>果动网</a></h1></br>欢迎您！</span><br /><span style="font-size:15px;"><br />和果冻一起动起来吧！<br />点击（或双击页面）有惊喜哦！<br /><a href="index.html"><h2>点我进入果动网</h2>5秒后自动跳转</a></span>';
